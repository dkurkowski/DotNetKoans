...
namespace DotNetKoans.CSharp
{
    public class AboutControlStatements : Koan
    {
        ...
        public void ContinueStatement()
        {
            ...
            Assert.Equal(new System.Collections.Generic.List<int>(new int[] {1, 3, 5, 7, 9}), result);
        }
        ...
        public void ForStatement()
        {
            ...
            Assert.Equal(new System.Collections.Generic.List<string>(new string[] {"FISH", "AND", "CHIPS"}), list);
        }
        ...
        public void ForEachStatement()
        {
            ...
            Assert.Equal(new System.Collections.Generic.List<string>(new string[] {"FISH", "AND", "CHIPS"}), finalList);
        }
